            ...
            <div className="col-lg-5 ml-lg-5">
              ...
              <div className="row mx-3">
                <p className="text-justify">
                  ...
                  na 11º edição da Semana Omnistack. Tendo o objetivo de criar
                  um sistema Web e Mobile para ajudar ONGs (Organizações Não
                  Governamentais) mostrando os casos que necessitam de ajuda.
                </p>
                <br />
                <p className="text-justify">
                  Essa versão foi criada por mim tendo o objetivo de incrementar
                  o meu portfólio de projetos, utilizando tecnologias como
                  NodeJS, React, React Native, Google Cloud App Engine, Google
                  Cloud Endpoint (API Gateway), Google Storage e Google
                  Filestore. Esse sistema está hospedado no{" "}
                  <a
